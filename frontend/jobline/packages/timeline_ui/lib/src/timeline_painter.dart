...
import 'package:timeline_ui/timeline_ui.dart';
...
class _TimelinePainterCenter extends _TimelinePainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    if (!isFirst && offsetTop != null && topLineEnd != null)
      canvas.drawLine(offsetTop, topLineEnd, linePaint);
...
class _TimelinePainterRight extends _TimelinePainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    final Offset? top =
        configuration.size?.topRight(Offset(rightOffset.dx, 0.0));
    final Offset? centerTop = configuration.size
