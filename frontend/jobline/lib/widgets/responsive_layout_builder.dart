...
import 'package:jobline/layout/layout.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= JoblineBreakpoints.small) {
          return small(context, child);
        }
        if (constraints.maxWidth <= JoblineBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        if (constraints.maxWidth <= JoblineBreakpoints.large) {
